...
# plt.plot(range(1, 21), beginner, 'o', color='blue', label='Beginner (2 seconds)')
# plt.plot(range(1, 21), medium, 'o', color='orange', label='Medium (6 seconds)')
# plt.plot(range(1, 21), expert, 'o', color='green', label='Expert (12 seconds)')
# plt.legend(loc='best')
# plt.savefig('foo.png')
# plt.show()
